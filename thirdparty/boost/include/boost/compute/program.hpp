...
public:
                                           ...
                                           const context &context)
    {
        ...
        for(size_t i = 0; i < files.size(); ++i) {
            // open file stream
            boost::filesystem::ifstream stream(files[i].c_str());
    ...
    {
        // open file stream
        boost::filesystem::ifstream stream(file.c_str(), std::ios::in | std::ios::binary);
...
private:
            ...
            )
    {
        ...
        boost::filesystem::ifstream bfile(fname.c_str(), std::ios::binary);
    ...
    {
        // open file stream
        boost::filesystem::ifstream stream(file.c_str());
