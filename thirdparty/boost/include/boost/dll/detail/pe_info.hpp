...
private:
    ...
    static exports_t exports(boost::filesystem::ifstream& fs, const header_t& h) {
    ...
    static std::size_t get_file_offset(boost::filesystem::ifstream& fs, std::size_t virtual_address, const header_t& h) {
